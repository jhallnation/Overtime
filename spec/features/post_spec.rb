...
describe 'navigate' do
  ...
  describe 'index' do 
    ...
    it 'has a scope so that only post creators can see their posts' do
      post1 = Post.create(date: Date.today, ratinale: "asdf", user_id: @user.id)
      post2 = Post.create(date: Date.today, ratinale: "asdf", user_id: @user.id)
      ...
      post_from_other_user = Post.create(date: Date.today, ratinale: "This post shouldn't be seen", user_id: other_user.id)
  ...
  describe 'edit' do
    before do
      ...
      @edit_post = Post.create(date: Date.today, ratinale: "asdf", user_id: @edit_user.id)
    end
